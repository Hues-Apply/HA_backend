...
class MatchingAlgorithmTests(TestCase):
    ...
    def test_opportunity_matching(self):
        ...
        # Check scores - perfect match should be close to 100
        self.assertGreaterEqual(recommendations[0]['score'], 90)
        # Partial match should be in middle range
        self.assertGreaterEqual(recommendations[1]['score'], 40)
        # Non-match should be low score
        self.assertLessEqual(recommendations[2]['score'], 30)
